    ...
    public static class TransferManagerPatches
    {
        ...
        public static bool SupportedTransfer(TransferManager.TransferReason reason)
        {
            switch (reason)
            {
                ...
                case (TransferManager.TransferReason)128: // prison helicopter mod
                case (TransferManager.TransferReason)129: // prison helicopter mod
                case (TransferManager.TransferReason)130: // prison helicopter mod
                    return true;
