...
namespace TransferController
{
    ...
    internal static class OptionsPanelManager
    {
        ...
        private static TCOptionsPanel panel;

        // Accessors.
        internal static TCOptionsPanel Panel => panel;
        ...
        private static void Create()
        {
            try
            {
                ...
                if (optionsGameObject == null)
                {
                    ...
                    optionsGameObject = new GameObject("TCOptionsPanel");
                    ...
                    panel = optionsGameObject.AddComponent<TCOptionsPanel>();
